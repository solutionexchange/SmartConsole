Function Get-MSAllApplicationServers {
    ...
    process {
        ...
        Set-MSTimestamp;
        $Request = ("<IODATA loginguid='[!guid_login!]' sessionkey='[!key!]' dialoglanguageid='[!dialog_language_id!]'><ADMINISTRATION><EDITORIALSERVERS action='list'/></ADMINISTRATION></IODATA>");
