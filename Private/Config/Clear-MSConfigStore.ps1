Function Clear-MSConfigStore {
    ...
    process {
        ...
        Clear-Variable -Scope Global -Name ("MSConfigurationStore") -ErrorAction SilentlyContinue -ErrorVariable Error;
        if ($Error) {
